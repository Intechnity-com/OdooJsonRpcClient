...
{
    public class OdooRequestModelTests
    {
        private OdooConfig Confing = new OdooConfig("url","db", "user", "pass");
        [Fact]
        public void RequestModel_should_return_request_with_corect_params_count()
        {
            ...
            var requestTest = OdooRequestModel.SearchRead(Confing, 2, "table", queryTest);
